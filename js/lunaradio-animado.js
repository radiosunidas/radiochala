...
function hearthis() {
zurl = "https://streamlive2.hearthis.at:8000/status-json.xsl"/?rand="+ Math.random();
...
[/(chrome|omniweb|arora|[tihearthiska]{5}\s?browser)\/v?([\w\.]+)/i],
["name", "version"],
[/(dolfin)\/([\w\.]+)/i],
[
